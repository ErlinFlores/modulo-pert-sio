...
public class Demo1 implements IDemo{
    ...
    private void agregarTareas(){        
        ...
        Tarea tarea_A = FabricaDeTareas.getInstance().crearTarea("TAREA A", tiemposEstimados_A, 3, precedencia_A);
        ...
        Tarea tarea_B = FabricaDeTareas.getInstance().crearTarea("TAREA B", tiemposEstimados_B, 3, precedencia_B);
        ...
        Tarea tarea_C = FabricaDeTareas.getInstance().crearTarea("TAREA C", tiemposEstimados_C, 3, precedencia_C);
        ...
        Tarea tarea_D = FabricaDeTareas.getInstance().crearTarea("TAREA D", tiemposEstimados_D, 3, precedencia_D);
        ...
        Tarea tarea_E = FabricaDeTareas.getInstance().crearTarea("TAREA E", tiemposEstimados_E, 3, precedencia_E);
        ...
        Tarea tarea_F = FabricaDeTareas.getInstance().crearTarea("TAREA F", tiemposEstimados_F, 3, precedencia_F);
        ...
        Tarea tarea_G = FabricaDeTareas.getInstance().crearTarea("TAREA G", tiemposEstimados_G, 3, precedencia_G);
        ...
        Tarea tarea_H = FabricaDeTareas.getInstance().crearTarea("TAREA H", tiemposEstimados_H, 3, precedencia_H);
        ...
        Tarea tarea_I = FabricaDeTareas.getInstance().crearTarea("TAREA I", tiemposEstimados_I, 3, precedencia_I);
        ...
        Tarea tarea_J = FabricaDeTareas.getInstance().crearTarea("TAREA J", tiemposEstimados_J, 3, precedencia_J);
